...
#define catfeeder_api_EmbeddedResponse_init_default {false, 60000ull, false, 0, false, 0}
#define catfeeder_api_EmbeddedRequest_init_zero  {false, 0}
#define catfeeder_api_EmbeddedResponse_init_zero {false, 0, false, 0, false, 0}
...
extern const pb_field_t catfeeder_api_EmbeddedResponse_fields[4];

/* Maximum encoded size of messages (where known) */
#define catfeeder_api_EmbeddedRequest_size       11
#define catfeeder_api_EmbeddedResponse_size      28
